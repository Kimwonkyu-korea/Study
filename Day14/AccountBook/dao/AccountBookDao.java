...
public class AccountBookDao {
	...
	public AccountBookDao() {
		list.add(new AccountBookDto(2021, 9, 1, 30000, "지출","병원","진료비 20000원 + 약 값 10000원"));
		list.add(new AccountBookDto(2021, 9, 3, 20000, "지출","치킨","허니콤보 20000원"));
		list.add(new AccountBookDto(2021, 9, 8, 250000,"수입","재난지원금","1인당 25만원 지급"));
	}
	...
	public void Create() {
		...
		list.add(new AccountBookDto(year, month, day, money, inOut, title, content));
	...
	// 검색
	public void Read() {	
		System.out.print("1. 검색할 제목으로 검색 >> ");
		System.out.print("2. 검색할 날짜로 검색 >> ");
