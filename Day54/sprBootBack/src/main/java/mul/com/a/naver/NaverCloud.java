...
public class NaverCloud {
	...
	public static String processSTT(String filepath) {
		...
		String clientId = "uc367pfcjp";             // Application Client ID";
		String clientSecret = "Fce5ChJwxPHg8nirEO0aVe5AsKNzGkuljd9NNXCB"; 
	...
	public static String objectDetction(String filepath) {
		StringBuffer reqStr = new StringBuffer();
		String clientId = "uc367pfcjp";//애플리케이션 클라이언트 아이디값";
		String clientSecret = "Fce5ChJwxPHg8nirEO0aVe5AsKNzGkuljd9NNXCB";//애플리케이션 클라이언트 시크릿값";
		...
		try {
			String paramName = "image"; // 파라미터명은 image로 지정
			String imgFile = "C:\\Temp\\object.jpg";
			File uploadFile = new File(imgFile);
