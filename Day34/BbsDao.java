...
public class BbsDao {
	...
	public boolean updatecount(BbsDto dto) {
...
//		sql = sql + " WHERE RNUM BETWEEN ? AND ? ";
		...
		// pageNumber = 0 1 2 
		int start, end;
		start = 1 + 10 * pageNumber;	// 1 2 
		end = 10 + 10 * pageNumber;		// 10 20
	...
	public int getAllBbs(String choice, String search) {	// 글의 총 갯수
	...
	public boolean deleteBbs(int seq) {	// void 가능
		String sql = " UPDATE BBS "
				+ 	 " SET DEL=1 "
				+ 	 " WHERE SEQ=? ";
