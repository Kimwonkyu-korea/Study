...
BbsDto bbs = dao.getBbs(seq);	// 부모글의 정보
%>
...
<tr>
	<th>내용</th>
	<td>
		<textarea rows="10" cols="70" readonly="readonly"><%=bbs.getContent() %></textarea>
	</td>
</tr>
</table>
</div>
...
<input type="hidden" name="seq" value="<%=bbs.getSeq() %>">	<!-- 데이터를 가지고 가지만, 감춰짐 -->
